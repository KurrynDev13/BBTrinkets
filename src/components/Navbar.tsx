        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center gap-2">
              <div className="w-10 h-10 bg-bb-navy text-bb-cream rounded-full flex items-center justify-center font-serif font-bold text-xl">
                B&B
              </div>
              <span className="font-serif font-bold text-2xl text-bb-navy tracking-tight">
                B&B TRINKETS
              </span>
            </Link>
          </div>
